...
<div class="container">
    <div class="page-header">
        <h1 class="all-tittles">Sistema de Ventas <small>Marcas</small></h1>
    </div>
</div>
<div class="container-fluid">
    ...
    <form id="frmRegistrar" name="frmRegistrar" method="post">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="marc" value="" id="marc" class="form-control"
                    placeholder="Escriba la descripcion de la Marca">
            </div>
        </div>
        <br>
