...
<div class="container-fluid">
    ...
    <form id="frmRegistrar" name="frmRegistrar" method="post">
        ...
        <div class="row form-group">
            <label for="dni" class="col-form-label col-md-2">Modelo</label>
            <div class="col-md-8">
        ...
        <br>
        <div class="row form-group">
               <label for="dni" class="col-form-label col-md-2">ID Marca</label>
               <div class="col-md-8">
                   <input type="text" name="idm" value="" id="idm" class="form-control"
                       placeholder="Escriba el numero del ID Marca ">
               </div>
           </div>
        <p class="text-center">
